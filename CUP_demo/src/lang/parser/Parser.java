...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Jul 04 18:46:29 UYT 2017
  */
public class Parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\016\000\002\005\004\000\002\002\004\000\002\005" +
    "\006\000\002\005\005\000\002\002\006\000\002\002\005" +
    "\000\002\003\005\000\002\003\003\000\002\003\007\000" +
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\034\000\004\021\006\001\002\000\010\002\033\007" +
    "\031\021\006\001\002\000\004\010\030\001\002\000\004" +
    "\004\007\001\002\000\014\005\017\020\011\021\016\022" +
    "\015\023\010\001\002\000\006\005\ufff7\007\ufff7\001\002" +
    "\000\006\005\ufff6\007\ufff6\001\002\000\006\005\ufffa\007" +
    "\ufffa\001\002\000\006\005\023\007\022\001\002\000\006" +
    "\005\ufff4\007\ufff4\001\002\000\006\005\ufff5\007\ufff5\001" +
    "\002\000\006\004\007\006\020\001\002\000\010\005\ufffc" +
    "\007\ufffc\010\ufffc\001\002\000\012\020\011\021\006\022" +
    "\015\023\010\001\002\000\006\005\ufffb\007\ufffb\001\002" +
    "\000\012\020\011\021\025\022\015\023\010\001\002\000" +
    "\010\005\ufffd\007\ufffd\010\ufffd\001\002\000\006\005\ufff8" +
    "\007\ufff8\001\002\000\006\004\007\006\026\001\002\000" +
    "\012\020\011\021\006\022\015\023\010\001\002\000\006" +
    "\005\ufff9\007\ufff9\001\002\000\010\002\001\007\001\021" +
    "\001\001\002\000\004\021\006\001\002\000\004\010\034" +
    "\001\002\000\004\002\000\001\002\000\010\002\ufffe\007" +
    "\ufffe\021\ufffe\001\002\000\004\010\036\001\002\000\010" +
    "\002\uffff\007\uffff\021\uffff\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\034\000\006\002\004\005\003\001\001\000\004\002" +
    "\031\001\001\000\002\001\001\000\002\001\001\000\010" +
    "\002\013\003\012\004\011\001\001\000\002\001\001\000" +
    "\002\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\002\001\001\000\002\001" +
    "\001\000\006\002\013\004\020\001\001\000\002\001\001" +
    "\000\006\002\013\004\023\001\001\000\002\001\001\000" +
    "\002\001\001\000\002\001\001\000\006\002\013\004\026" +
      ...
      switch (CUP$Parser$act_num)
		...
		Boolean b = (Boolean)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = b; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 9: // lista ::= lista COMMA valor 
            {
              Objeto RESULT =null;
		...
		Object v = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = l; RESULT.addElem(v); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 8: // lista ::= lista COMMA id COLON valor 
            {
              Objeto RESULT =null;
		...
		Objeto l = (Objeto)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = l; RESULT.setTag(tag); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 3: // root ::= root obj EOL 
            {
              List RESULT =null;
		int rleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).left;
		int rright = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).right;
		List r = (List)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-2)).value;
		...
		Objeto o = (Objeto)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = r; RESULT.add(o); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 2: // root ::= root COMMA obj EOL 
            {
              List RESULT =null;
		int rleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-3)).left;
		int rright = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-3)).right;
		List r = (List)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-3)).value;
		int oleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)).left;
		int oright = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)).right;
		Objeto o = (Objeto)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = r; RESULT.add(o); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("root",3, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-3)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
		...
		int oright = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)).right;
		Objeto o = (Objeto)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = new ArrayList(); RESULT.add(o); 
